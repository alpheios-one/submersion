...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String diveLog_sources_separateDialog_body(int count) {
    return 'تم دمج هذه الغوصة من $count غوصات. يعود ملف كل غوصة وأحداثها وأسطواناتها وتبديلات الغاز إلى غوصتها الخاصة. تبقى رفقاء الغوص والوسوم والمعدات والوسائط والملاحظات ورقم الغوصة في هذه الغوصة.';
  }
