...
class AppLocalizationsHe extends AppLocalizations {
  ...
  String diveLog_sources_separateDialog_body(int count) {
    return 'הצלילה הזו מוזגה מ-$count צלילות. הפרופיל, האירועים, הבלונים והחלפות הגז של כל אחת יחזרו לצלילה שלה. השותפים, התגיות, הציוד, המדיה, ההערות ומספר הצלילה יישארו בצלילה הזו.';
  }
