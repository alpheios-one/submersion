...
class DiverSettingsRepository {
      ...
      await _db
          ...
          .insert(
            DiverSettingsCompanion(
              ...
              autoTagDiveComputerImports: Value(s.autoTagDiveComputerImports),
    ...
    try {
      ...
      await (_db.update(
        ...
        DiverSettingsCompanion(
          ...
          autoTagDiveComputerImports: Value(
            settings.autoTagDiveComputerImports,
          ),
  ...
  AppSettings _mapRowToAppSettings(DiverSetting row) {
    return AppSettings(
      ...
      autoTagDiveComputerImports: row.autoTagDiveComputerImports,
