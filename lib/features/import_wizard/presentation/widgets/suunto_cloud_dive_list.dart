...
/// Builds the same title/subtitle text shown for a Suunto dive both in the
...
({String title, String subtitle}) formatSuuntoDiveSummary(
...
/// Suunto cloud import wizard's fetch step.
///
...
/// shared Review step.
class SuuntoCloudDiveList extends StatelessWidget {
  const SuuntoCloudDiveList({
    super.key,
    required this.dives,
  ...
  final List<SuuntoParsedDive> dives;
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        final summary = formatSuuntoDiveSummary(dives[index], settings);
