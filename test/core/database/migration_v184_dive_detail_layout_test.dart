...
/// Minimal pre-v184 shape: a diver_settings table without the layout column,
/// stamped at v183 so the upgrade to 184 runs.
...
void main() {
  test('v184 adds dive_detail_layout to an existing table', () async {
