...
void main() {
  test('v207 is the current schema version and is in the ladder', () {
    // greaterThanOrEqualTo, not an exact match: a later rung (e.g. #998's
    // v208) legitimately raises currentSchemaVersion further, and that must
    // not break this test -- only v207's own presence in the ladder matters
    // here.
